...
export default function SearchAndSort () {
  ...
  return (
    <div className="flex flex-col  md:flex-row gap-4 md:gap-6 w-full max-w-5xl mx-auto mt-6">
      ...
      <div className="w-full md:w-1/2  relative">
        <input
          ...
          className="w-full text-right px-12 py-3 bg-white rounded-2xl shadow-md border border-gray-200 text-sm"
        />
      ...
      <div className="relative w-full md:w-1/2">
        <button
          ...
          className="w-full text-right px-4 py-3 bg-white rounded-2xl shadow-md border border-gray-200 text-sm flex justify-between items-center"
        >
          {selectedSort}
